...
namespace Objects.DocBot.States // PROPER HIERARCHY (Stores all of DocBot's states)
{
    ...
    public class ReturnWorkshopState : State<string> // TNm determines the datatype of the name (key)
    {

        private DocBotFSM fsm;
        
        public ReturnWorkshopState(DocBotFSM fsm, string typeName, GenericStateManager<string> stateManager) : base(stateManager, typeName) 
