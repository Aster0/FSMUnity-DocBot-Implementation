...
namespace Objects.DocBot.States // PROPER HIERARCHY (Stores all of DocBot's states)
{
    ...
    public class ReturnRecycleState : State // TNm determines the datatype of the name (key)
    {

        private DocBotFSM fsm;
        
        public ReturnRecycleState(DocBotFSM fsm, string typeName, GenericStateManager stateManager) : base(stateManager, typeName) 
